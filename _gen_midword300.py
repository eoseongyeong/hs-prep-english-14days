#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the 중학필수 영단어 300 flashcard course (30 days x 10 words), output to docs/midword300/."""
...
OUT = ROOT / "docs" / "midword300"
OUT.mkdir(parents=True, exist_ok=True)

BRAND = "중학필수 영단어 300"
TOTAL_DAYS = 30

WORDS = {int(k): v for k, v in json.loads((ROOT / "_midword300_data.json").read_text(encoding="utf-8")).items()}

DAY_TOPICS = {
    1: "감정·성격 심화", 2: "학교·학습 심화", 3: "의사소통 표현", 4: "사회·공동체", 5: "환경",
    6: "과학·발명", 7: "건강·질병", 8: "문화·전통", 9: "여행·경험", 10: "기술·미디어",
    11: "경제·소비", 12: "자연재해·날씨", 13: "우주·지구", 14: "관계·우정", 15: "진로·목표",
    16: "문제해결·의견", 17: "비교·대조 표현", 18: "동작·행동 심화", 19: "스포츠·경쟁", 20: "예술·창작",
    21: "안전·규칙", 22: "시간·순서 표현", 23: "동식물·생태", 24: "음식·요리 심화", 25: "교통·이동 심화",
    26: "미디어·뉴스", 27: "예의·매너", 28: "정보·데이터", 29: "성장·변화", 30: "종합 복습",
}
...
<head>
  ...
  <link rel="stylesheet" href="midword300.css" />
</head>
<body class="fc-body">
  ...
  <script src="midword300.js"></script>
</body>
</html>
"""
  ...
  <div class="wrap">
    ...
    <section class="card">
      ...
      <div class="course-grid">
        <a class="course-card" href="../word300/index.html">
          <span class="chip">입문</span>
    ...
    <section class="card">
      ...
      <p class="muted">문법 설명 없이 단어만 가볍게 익히는 코스입니다. 초등필수 300보다 한 단계 어려운 중학 수준 단어입니다.</p>
    </section>
...
def main():
    ...
    for n in range(1, TOTAL_DAYS + 1):
        ...
        print(f"wrote docs/midword300/day{n}.html")
    (OUT / "index.html").write_text(render_index(), encoding="utf-8")
    print("done — midword300 30 html files generated in docs/midword300/")
